...
2. **استفاده در ایران**:
   ...
   - سایت‌هایی که فقط DNS شان فیلتر شده (مثل برخی سایت‌های خارجی) باز می‌شوند
...
- استفاده از کلاینت‌های Xray مثل V2RayX
...
5. اگر مشکل ادامه دارد، از نسخه ساده‌تر کانفیگ استفاده کنید
